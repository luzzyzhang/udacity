...
import random
from hold_at_strategy import hold_at
...
def clueless(state):
    """A strategy that ignores the state and
    chooses at random from possible moves.
    """
...
def test():
    ...
    rolls = iter([6, 6, 6, 6, 6, 6, 6, 6, 2])  # <= fix this: shortest list that allows A to win
